      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Manage and evaluate your real estate acquisitions.
          </p>
        </div>
          ...
          <table className="w-full text-left border-collapse data-dense-table">
            ...
            <tbody>
              ...
              {filteredDeals.map((deal) => (
                ...
                >
                  <td
                    className="font-medium text-slate-900 truncate max-w-[250px]"
                    title={deal.address}
                  >
                    <Link
                      href={`/deals/${deal.id}`}
                  ...
                  <td className="text-right font-mono">
                    <span
                      className={cn(
                        "font-semibold",
                        (deal.projectedReturn || 0) >= 15
                          ? "text-success"
                          : (deal.projectedReturn || 0) > 8
                            ? "text-warning"
                            : "text-slate-600",
                      )}
                    >
                  ...
                  <td>
                    <SignalBadge signal={deal.offerSignal} />
                  </td>
